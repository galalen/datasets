...
SplitGenerator = Union[
    Iterable[KeyExample],
    'beam.PTransform',  # Is it possible to add typing anotation ?
...
class SplitBuilder:
  ...
  * `split_info_future.result()`: Called after all `beam.PCollection`s have
  ...
  def normalize_split_generators(
      self,
  ...
  def submit_split_generation(
    ...
    # DO NOT SUBMIT: Check that PTransform and PCollection are not Iterable
